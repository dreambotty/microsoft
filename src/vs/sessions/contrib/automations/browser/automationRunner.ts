...
export class AutomationRunner implements IAutomationRunner {
	...
	private async _runOnceInner(
		...
		try {
			...
			const createOptions: ICreateNewSessionOptions | undefined = automation.providerId != null || automation.sessionTypeId != null || automation.modelId != null || automation.mode != null || automation.permissionLevel != null || automation.isolationMode != null || automation.branch != null
				? {
